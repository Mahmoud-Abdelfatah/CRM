			...
			<div class="row">
				<div class='col-sm-6'>
					<div class="form-group">
						...
						<div class='input-group date' id='datetimepicker1'>
							<select class="selectpicker form-control" multiple data-live-search="true" name="queue[]">
								<?php
                                   foreach ($queues as $queue) {
                                   	 echo '<option value="'.$queue['queue'].'">'.$queue['queue'].'</option>';
                                   }
								?>
			  ...
			  <input type="submit" name="queue_submit" value="Submit" class="btn btn-primary" style="float: right">
			</form>
  </div>
</div>
</div>
