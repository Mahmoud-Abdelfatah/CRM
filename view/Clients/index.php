...
if(isset($_GET['ANI']))
{
  $time=date('Y-m-d H:i:s');
   header('location:../../controller/Clients_controller.class.php?ANI='.$_GET['ANI'].'&AGENT='.$_GET['AGENT_ID'].'&time='.$time.'&num='.$_GET['num'].' ');
}
?>
<!DOCTYPE html>
<html>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <ul class="nav navbar-nav ml-auto" style="float: right;">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../crm_rep">CRM Report</a>
      </li>
...
<body style="background: #DEDEDE;">
  ...
  <form class="search-form" action="../../controller/Clients_controller.class.php" method="POST">
  <input type="search" value="" placeholder="Search" class="search-input" name="Search" required>
  <button type="submit" class="search-button" name="search_cleint_submit">
  ...
  <div class="search-option">
    <div>
            <a href="Add_Client_v1.php" class="glyphicon glyphicon-user"></a>
